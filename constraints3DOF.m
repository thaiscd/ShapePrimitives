function [c,ceq] = constraints3DOF(x, MPs, Obs, OC)
...
% constraints on a
for i = 1:nMPs
    ceq1 = sqrt((a(2*i-1) - o(1))^2 + (a(2*i) - o(2))^2) - r0;
    ceq = [ceq; ceq1];
end
...
for i = 1:nMPs
    if MPs(i,1) == 1
        ...
        [cl, ceql] = line_constraints(a(2*i-1:2*i)', r1, r2, bl1, bl2, pl1, pl2, Obs);
        [cself] = SelfColl2l(pl1, pl2, o, a(2*i-1:2*i)') + eps;
    ...
    elseif MPs(i,1) == 0
        ...
        [cc, ceqc] = circle_constraints(a(2*i-1:2*i)', r1, r2, bc, pc, center, radius, Obs);
        ...
        [ca, ceqa] = arc_constraints(dir, ang, a(2*i-1:2*i)', r1, r2, ba1, ba2, pa1, pa2, center, radius, Obs);
