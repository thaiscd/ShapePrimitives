function [c,ceq] = constraints2DOF(x, MPs, Obs, OC)
...
for i = 1:nMPs
    if MPs(i,1) == 1
        ...
        [cl, ceql] = line_constraints(a, r1, r2, bl1, bl2, pl1, pl2, Obs); % line segment constraints
    ...
    elseif MPs(i,1) == 0
        ...
        [cc, ceqc] = circle_constraints(a, r1, r2, bc, pc, center, radius, Obs); % circle constraints
        ...
        [ca, ceqa] = arc_constraints(dir, ang, a, r1, r2, ba1, ba2, pa1, pa2, center, radius, Obs); % arc constraints
